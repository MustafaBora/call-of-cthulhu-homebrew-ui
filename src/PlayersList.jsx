...
const styles = {
  page: {
    minHeight: "100vh",
    padding: "2rem",
    background: "linear-gradient(135deg, #1a3a2e 0%, #0f1e17 50%, #1a1a2e 100%)", // Koyu Cthulhu teması
  ...
  cardWrapper: {
    ...
    borderRadius: "1rem",
    padding: "1.5rem",
    boxShadow: "0 0 30px rgba(76, 175, 80, 0.15), inset 0 0 60px rgba(0, 0, 0, 0.3)",
  },
  headerRow: {
    display: "flex",
  ...
  title: {
    ...
    fontWeight: 700,
    color: "#4caf50",
    textShadow: "0 0 10px rgba(76, 175, 80, 0.5), 0 2px 4px rgba(0, 0, 0, 0.8)",
  ...
  importButton: {
    ...
    borderRadius: "0.5rem",
    border: "2px solid #2e5c47",
    background: "linear-gradient(135deg, #1e4d3c 0%, #2e5c47 100%)",
    color: "#b8d4c0",
    fontWeight: 700,
    fontSize: "0.8rem",
    cursor: "pointer",
    boxShadow: "0 4px 10px rgba(0,0,0,0.5), 0 0 15px rgba(76, 175, 80, 0.2)",
  ...
  newPlayerButton: {
    ...
    background: "linear-gradient(135deg, #2e7d4e 0%, #4caf50 100%)",
    color: "#0d1e15",
    fontWeight: 700,
    fontSize: "0.8rem",
    cursor: "pointer",
    boxShadow: "0 4px 10px rgba(0,0,0,0.5), 0 0 20px rgba(76, 175, 80, 0.4)",
    flex: "0 1 auto",
    textAlign: "center",
    whiteSpace: "nowrap",
    transition: "all 0.3s ease",
  ...
  card: {
    background: "linear-gradient(135deg, rgba(25, 45, 35, 0.95) 0%, rgba(30, 50, 40, 0.95) 100%)",
    borderRadius: "0.9rem",
    border: "2px solid #2e5c47",
    padding: "0.9rem 1rem",
    boxShadow: "0 10px 30px rgba(0,0,0,0.6), 0 0 20px rgba(76, 175, 80, 0.15)",
    transition: "all 0.3s ease",
  },
  cardRow: {
    display: "flex",
  ...
  avatarWrapper: {
    ...
    borderRadius: "12px",
    overflow: "hidden",
    border: "3px solid #2e5c47",
    background: "linear-gradient(135deg, #1a3a2e, #2e5c47)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    flex: "0 1 180px",
    alignSelf: "stretch",
    boxShadow: "0 0 15px rgba(76, 175, 80, 0.3), inset 0 0 20px rgba(0, 0, 0, 0.5)",
  },
  avatarImg: {
    width: "100%",
    height: "100%",
  ...
  nameLine: {
    ...
    overflow: "hidden",
    color: "#8bc34a",
    textShadow: "0 0 8px rgba(139, 195, 74, 0.4)",
  },
  subLine: {
    fontSize: "0.8rem",
    color: "#a8bfaa",
  ...
  editButton: {
    ...
    border: "2px solid #2e5c47",
    background: "linear-gradient(135deg, #1e4d3c, #2e5c47)",
    color: "#b8d4c0",
    fontWeight: 600,
    fontSize: "0.85rem",
    cursor: "pointer",
    boxShadow: "0 4px 10px rgba(0,0,0,0.5), 0 0 10px rgba(76, 175, 80, 0.2)",
    transition: "all 0.3s ease",
  },
